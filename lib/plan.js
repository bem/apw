...
//ASSERT: такой id должен существовать — позволяет выявить попытки работать с несуществующими нодами.
...
//ASSERT: такой child должен существовать — позволяет выявить попытки работать с несуществующими нодами.
//ASSERT: такой parent должен существовать — позволяет выявить попытки работать с несуществующими нодами.
...
//ASSERT: такой id1 должен существовать — позволяет выявить попытки работать с несуществующими нодами.
//ASSERT: такой id2 должен существовать — позволяет выявить попытки работать с несуществующими нодами.
...
//ASSERT: такой id должен существовать — позволяет выявить попытки работать с несуществующими нодами.
     ...
     */
    onAllDone: function() {
//ASSERT: план не locked — позволяет выявить незавершённые "транзакции".
//ASSERT: children и parents пусты (только root есть) — позволяет выявить "оторвавшиеся" от плана ветки.
